...
<div class="fh5co-loader"></div>
	...
	<div id="fh5co-blog">
		<div class="container">
			<h3 id = "weatherjisu"> 메뉴 수정 </h3>
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="fh5co-blog animate-box">
						<div class="blog-text">
							<form action="updateProductProc.do?product_no=${vo2.product_no }", method="post" enctype="multipart/form-data" id="ufrm">
								<table class="table">
									<tr>
										<th class="hidden2">메뉴 이름 </th>
										<td>
										<div class="hidden1">* 메뉴 이름 </div>
										<input type="text" name="product_name" id="product_name" value="${vo2.product_name }"/><p id="nameck" class="error"></p></td>
									</tr>
									<tr>
										<th class="hidden2">메뉴 설명 </th>
										<td>
										<div class="hidden1">* 메뉴 설명 </div>
										<textarea name="product_detail" id="product_detail" cols="35" rows="10">${vo2.product_detail }</textarea><p id="bodyck" class="error"></p></td>
									</tr>
									<tr>
										...
										<div id='View_area'>
										<img src="<c:url value="resources/images/recommend/${filename}"/>" id="imgtemp">
										</div>
										<input type="hidden" name="product_image" id="product_image" value="resources/images/recommend/${filename}"/>
