...
public class NaverLoginBO {
    ...
    //state: ���ø����̼��� ������ ���� ��ū
    private final static String CLIENT_ID = "BGF1A8TeiOaipMjT7HsF";       //���̹�API Client ID
    private final static String CLIENT_SECRET = "GIBBBQ3OTs";                      
    private final static String REDIRECT_URI = "http://teamJesus.iptime.org/proj/callback.do";
